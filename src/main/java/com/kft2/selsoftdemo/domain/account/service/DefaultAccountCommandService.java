...
import com.kft2.selsoftdemo.domain.account.repository.AccountAdapter;
...
public class DefaultAccountCommandService implements AccountCommandService {
    ...
    public String signIn(SignInRequest signInRequest) {
        try {
            ...
            return jwtTokenProvider.createToken(signInRequest.getEmail(), accountAdapter.findByEmail(signInRequest.getEmail()).getRoles());
        } catch (Exception e) {
